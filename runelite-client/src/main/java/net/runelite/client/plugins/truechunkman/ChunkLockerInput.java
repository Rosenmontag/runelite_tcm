...
public class ChunkLockerInput implements KeyListener {

    static Keybind UNLOCK_KEY;
    static Keybind BLOCK_KEY;
    static Keybind ROLL_KEY;

    @Inject
    private ChunkLockerPlugin plugin;
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (ROLL_KEY.matches(e))
        {
            plugin.onRollKeyReleased();
        }
    }
}
